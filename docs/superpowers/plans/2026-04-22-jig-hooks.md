...
| `docs/v2.0/implementation-plan.md` | Modify | Check off Phase 5 Task I items. |
...
Edit `docs/v2.0/implementation-plan.md` — the Phase 5 Task I block at lines ~1545-1558. Change each `- [ ]` to `- [x]`.
