...
became this package), the contract, and the lightweight ``FixtureRunAgent``.
``RealRunAgent`` pulls in the whole agent stack and is imported explicitly from
``jig.runtime.real`` to keep this package cheap for its many consumers.
"""
