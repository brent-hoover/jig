"""bones-with-fixture-replay scenario end-to-end (Track E Final, mock mode).

Exercises ``invoke_fixture_replay`` — the vcr-style cassette record +
...
@pytest.mark.asyncio
async def test_bones_with_fixture_replay_passes_in_mock_mode(tmp_path: Path):
    _seed_repo(tmp_path)
